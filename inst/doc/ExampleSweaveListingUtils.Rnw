...
\svnidlong
{$HeadURL: svn+ssh://ruckdeschel@svn.r-forge.r-project.org/svnroot/distr/pkg/SweaveListingUtils/inst/doc/ExampleSweaveListingUtils.Rnw $}
{$LastChangedDate: 2011-09-02 16:08:36 +0200 (Fr, 02 Sep 2011) $}
