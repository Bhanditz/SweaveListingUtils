...
\svnidlong
{$HeadURL: svn+ssh://stamats@svn.r-forge.r-project.org/svnroot/distr/branches/distr-2.2/pkg/SweaveListingUtils/inst/doc/ExampleSweaveListingUtils.Rnw $}
{$LastChangedDate: 2009-09-28 13:43:37 +0200 (Mo, 28. Sep 2009) $}
