...
\svnidlong
{$HeadURL: svn+ssh://ruckdeschel@svn.r-forge.r-project.org/svnroot/distr/branches/distr-2.6/pkg/SweaveListingUtils/vignettes/ExampleSweaveListingUtils.Rnw $}
{$LastChangedDate: 2015-11-06 11:11:17 +0100 (Fr, 06 Nov 2015) $}
